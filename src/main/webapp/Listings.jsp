...
<body>
	...
	<div style="text-align: center">
		...
		<table align="center" border="1">
			...
			List<String> validSortFields = Arrays.asList("make", "model", "color", "year", "initial_price", "min_sale",
					"date_time");
			...
			try {
				...
				String query = "SELECT listing_id, make, model, color, year, initial_price, min_sale, date_time, open_close FROM listings ORDER BY "
				+ sortByField;
