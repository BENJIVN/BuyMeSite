...
<body>
	...
	<form action="checkLoginDetails.jsp" method="POST">
		<table style="margin: 0px auto;">
			...
			<tr>
				<td><a href="AdminLogin.jsp">Click here if you're an
						Administrator!</a></td>
			</tr>
			<tr>
				<td><a href="CustomerRepLogin.jsp">Click here if you're a
						Customer Representative!</a></td>
			</tr>
			<td><a href="register.jsp"> Click here if you need an
					account!</a></td>
			<tr></tr>
		</table>
	</form>
